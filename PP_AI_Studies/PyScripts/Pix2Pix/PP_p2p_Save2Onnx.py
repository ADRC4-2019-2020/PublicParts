...
# output_onnx_path = os.path.dirname(__file__) + '/saved_models/onnx_models/pp_p2p_k2o_b.onnx'
# onnx_model = keras2onnx.convert_keras(loaded_generator, loaded_generator.name, target_opset=10)
