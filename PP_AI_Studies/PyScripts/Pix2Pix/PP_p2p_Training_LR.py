...
# Modified for Public Parts Project, Low resolution version
...
PATH = os.path.dirname(__file__) + '/plans_LR/'

output_dir = PATH + '/output/'

checkpoint_dir = './training_checkpoints_LR'
...
# inp, re = load(PATH+'train/20_20_A_1.png')
...
def random_jitter(input_image, real_image):
  ...
  input_image, real_image = resize(input_image, real_image, IMG_HEIGHT + 6, IMG_WIDTH + 6)
